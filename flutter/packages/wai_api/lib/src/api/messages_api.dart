...
import 'package:wai_api/src/api_util.dart';
...
class MessagesApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [MessageList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MessageList>> listMessages({ 
    ...
    final _path = r'/chats/{chatId}/messages'.replaceAll('{' r'chatId' '}', encodeQueryParameter(_serializers, chatId, const FullType(String)).toString());
    ...
    MessageList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(MessageList),
      ) as MessageList;
