...
class MessagesApi {
  ...
  Future<Response<Message>> callPersona({ 
    required String chatId,
    required CallPersonaRequest callPersonaRequest,
    ...
    final _path = r'/chats/{chatId}/call-persona'.replaceAll('{' r'chatId' '}', encodeQueryParameter(_serializers, chatId, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(CallPersonaRequest);
      _bodyData = _serializers.serialize(callPersonaRequest, specifiedType: _type);
