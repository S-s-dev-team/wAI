...
2. **コミットメッセージのlint を導入する**（たとえば `commitlint` + `husky` など）。[Zenn](https://zenn.dev/wakamsha/articles/about-conventional-commits?utm_source=chatgpt.com)
...
ほかにも以下のようなものがある(CLI上からコミットを行うとき有効)
